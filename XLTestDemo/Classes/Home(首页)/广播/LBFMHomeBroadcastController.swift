...
extension LBFMHomeBroadcastController: JXSegmentedListContainerViewListDelegate {
...
class LBFMHomeBroadcastController: UIViewController {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        // MARK -注册头视图和尾视图
        collectionView.register(LBFMRadioHeaderView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: LBFMRadioHeaderViewID)
        collectionView.register(LBFMRadioFooterView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: LBFMRadioFooterViewID)
        // 注册不同分区cell
        collectionView.register(LBFMHomeRadiosCell.self, forCellWithReuseIdentifier:LBFMHomeRadiosCellID)
        collectionView.register(LBFMRadioSquareResultsCell.self, forCellWithReuseIdentifier:LBFMRadioSquareResultsCellID)
