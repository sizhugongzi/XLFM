...
class LBFMClassifySubRecommendController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        // - 注册头视图和尾视图
        collectionView.register(LBFMClassifySubHeaderView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: LBFMClassifySubHeaderViewID)
        collectionView.register(LBFMClassifySubFooterView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: LBFMClassifySubFooterViewID)
        // - 注册不同分区cell
        collectionView.register(LBFMClassifySubHeaderCell.self, forCellWithReuseIdentifier: LBFMClassifySubHeaderCellID)
        collectionView.register(LBFMClassifySubHorizontalCell.self, forCellWithReuseIdentifier: LBFMClassifySubHorizontalCellID)
        collectionView.register(LBFMClassifySubVerticalCell.self, forCellWithReuseIdentifier: LBFMClassifySubVerticalCellID)
        collectionView.register(LBFMClassifySubModuleType20Cell.self, forCellWithReuseIdentifier: LBFMClassifySubModuleType20CellID)
        collectionView.register(LBFMClassifySubModuleType19Cell.self, forCellWithReuseIdentifier: LBFMClassifySubModuleType19CellID)
        collectionView.register(LBFMClassifySubModuleType17Cell.self, forCellWithReuseIdentifier: LBFMClassifySubModuleType17CellID)
        collectionView.register(LBFMClassifySubModuleType4Cell.self, forCellWithReuseIdentifier: LBFMClassifySubModuleType4CellID)
        collectionView.register(LBFMClassifySubModuleType16Cell.self, forCellWithReuseIdentifier: LBFMClassifySubModuleType16CellID)
        collectionView.register(LBFMClassifySubModuleType23Cell.self, forCellWithReuseIdentifier: LBFMClassifySubModuleType23CellID)
        collectionView.uHead = URefreshHeader{ [weak self] in self?.loadRecommendData() }
