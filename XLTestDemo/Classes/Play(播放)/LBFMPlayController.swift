...
class LBFMPlayController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        // - 注册头视图和尾视图
        collectionView.register(LBFMPlayHeaderView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: LBFMPlayHeaderViewID)
        collectionView.register(LBFMPlayFooterView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: LBFMPlayFooterViewID)
        // - 注册不同分区cell
        collectionView.register(LBFMPlayCell.self, forCellWithReuseIdentifier: LBFMPlayCellID)
        collectionView.register(LBFMPlayCommentCell.self, forCellWithReuseIdentifier: LBFMPlayCommentCellID)
        collectionView.register(LBFMPlayAnchorCell.self, forCellWithReuseIdentifier: LBFMPlayAnchorCellID)
        collectionView.register(LBFMPlayCircleCell.self, forCellWithReuseIdentifier: LBFMPlayCircleCellID)
